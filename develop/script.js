...
//javascript is in military time
for (let i = 9; i < 18; i++) {

  var text = localStorage.getItem("#hour-"+ i)
      $("#hour-"+ i).children("textarea").val(text)
      if (currentHour === i) {
        // grabs id plus the hour (i), it is a child of hour (textarea), adds class present depending on i
    ...
    $(".saveBtn").on("click", function () {
      ...
      // this places the value in local storage
